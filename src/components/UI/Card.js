...
<img className="rounded-full" src={picture} alt=""/>
    ...
    <div className="p-5">
        <a href="/">
            <h5 className="mb-4 text-4xl font-bold tracking-tight text-red-700 dark:text-red">Welcome!</h5>
        </a>
        <p className="mb-4 font-normal text-black-700 dark:text-black-400">A Front-End Developer | FreeLancer</p>
        ...
        <div className="object-right rounded-lg max-w-smborder-gray-200">
    </div>
</div>
